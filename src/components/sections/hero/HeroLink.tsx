  ...
  return (
    <Link
      ...
      className="block bg-accent px-6 py-3 tracking-wider text-background uppercase
        transition-colors outline-none hover:bg-accentHover hover:text-primary/80
        focus-visible:bg-accentHover focus-visible:text-primary/80 focus-visible:ring-2
