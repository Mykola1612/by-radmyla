    ...
    <section id="hair" className="py-24 md:py-32">
      <div className="container-custom flex flex-col gap-y-16 justify-center items-center">
        <div className="flex flex-col gap-y-4 justify-center items-center text-center">
          <p className="text-accent uppercase tracking-widest">Головна послуга</p>
        ...
        <ul
          className="flex flex-col gap-y-6 justify-center items-center md:flex-row md:gap-x-1
            md:gap-y-0"
        >
          <li>
            <div
              className="flex gap-y-2 flex-col justify-center items-center xs:flex-row xs:gap-x-1
                xs:gap-y-0"
            >
              <div
                className="relative w-[170px] h-[226px] xs:w-[140px] xs:h-[186px] sm:w-[170px]
                  sm:h-[226px] lg:w-[234px] lg:h-[312px] xl:w-[298px] xl:h-[398px]"
              >
                <Image
        ...
        <ul
          className="flex flex-col sm:w-[342px] gap-y-6 justify-between items-center sm:flex-row
            sm:gap-x-1 md:gap-y-0 md:w-[692px] lg:w-[948px] xl:w-[1204px]"
        >
          <li>
            <div
              className="flex gap-y-2 flex-col justify-center items-center xs:flex-row xs:gap-x-1
            ...
            >
              <div
                className="relative w-[180px] h-[180px] sm:w-[104px] sm:h-[104px] md:w-[230px]
                  md:h-[230px] lg:w-[315px] lg:h-[315px] xl:w-[400px] xl:h-[400px]"
              >
                <Image
        ...
        <div
          className="bg-[#F8F8F8] w-full flex flex-col gap-y-10 justify-center items-center
            text-center py-12 px-10 sm:px-12 md:py-16"
        >
          <div className="flex flex-col gap-y-4 justify-center items-center text-center">
