export const FounderExpeerienceList = () => {
  return (
    <ul
      className="pt-16 mt-16 border-t border-accent/40 text-accent italic text-sm uppercase flex
        justify-between flex-col gap-y-6 sm:flex-row sm:gap-x-8 sm:gap-y-0"
    >
      <li>
